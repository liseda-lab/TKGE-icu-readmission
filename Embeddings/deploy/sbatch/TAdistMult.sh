...
uv venv .venv
# ================================== SIMPLE ==========================================
#CREATE THE FILES FOR GENERAL SIMPLE TEMPORAL PROCESS
uv run python3 -u Embeddings/embeddings/emb-TAdistMult/data_conversion.py \
...
uv run python3 -u Embeddings/embeddings/emb-TAdistMult/preprocess_TA.py \
        --dataset MIMIC_TA \
        --datapath /Embeddings/embeddings/resources/TA_TransE/data

#RUN THE MODEL
uv run python3 -u Embeddings/embeddings/emb-TAdistMult/runTAdistMult.py \
        --dataset MIMIC \
        --datapath /Embeddings/embeddings/resources/TA_TransE/data \
        ...
        --experiment TA-distmult_icuNcit_simple_300
    
# ================================== SEMANTIC ==========================================

#CREATE THE FILES FOR GENERAL SEMANTIC TEMPORAL PROCESS
uv run python3 -u Embeddings/embeddings/emb-TAdistMult/data_conversion.py \
...
uv run python3 -u Embeddings/embeddings/emb-TAdistMult/runTAdistMult.py \
        ...
        --output_path /path_to_out_dir \
        --experiment TA-distmult_icuNcit_semantic_300