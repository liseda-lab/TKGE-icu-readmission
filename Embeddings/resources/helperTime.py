...
def convert_to_fixed_intervals(timestamp, reference_point = '2000-01-01 00:00:00', interval_minutes=10):
    """
    ...
    minutes_since_ref = int((timestamp_dt - reference_dt).total_seconds() / 60)
    
    # Map to discrete intervals
    #discrete_time = int(minutes_since_ref // interval_minutes)
    return minutes_since_ref
